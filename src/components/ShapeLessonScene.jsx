// Composed shape scene, matching the alphabet/number lesson stage:
//   • a full-bleed illustrated background for the shape (meadow + big
//     smiling 3D shape + its name),
...
//   • a glowing real-world example pill next to the artwork.
//
...
export default function ShapeLessonScene({ name, shape, emoji, example }) {
  const bg = shapeImage(shape);
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      {/* Pointing teacher avatar — points toward the shape */}
      <img
        src={avatar}
        alt="Aunty Adesua"
      ...
      {/* Glowing real-world example pill */}
