// Composed number scene, matching the alphabet lesson stage:
//   • a full-bleed illustrated background for the number (jungle + big 3D
//     number + friend animal),
...
//   • a glowing number label pill next to the artwork.
//
...
export default function NumberLessonScene({ n, word, emoji }) {
  const bg = numberImage(n);
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      {/* Pointing teacher avatar — points toward the number */}
      <img
        src={avatar}
        alt="Aunty Adesua"
