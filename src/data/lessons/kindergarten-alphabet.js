...
// Words + emojis are aligned to the bundled per-letter illustrations
// (src/assets/images/letter-*.jpg) so the scene, label and narration all
// match the picture the child sees.
const ALPHABET = [
  ...
  { letter: "F", word: "Frog", emoji: "🐸", color: "from-emerald-200 to-emerald-100" },
  { letter: "G", word: "Grapes", emoji: "🍇", color: "from-teal-200 to-teal-100" },
  { letter: "H", word: "House", emoji: "🏠", color: "from-cyan-200 to-cyan-100" },
  { letter: "I", word: "Igloo", emoji: "❄️", color: "from-sky-200 to-sky-100" },
  { letter: "J", word: "Jellyfish", emoji: "🪼", color: "from-blue-200 to-blue-100" },
  { letter: "K", word: "Kangaroo", emoji: "🦘", color: "from-indigo-200 to-indigo-100" },
  { letter: "L", word: "Lion", emoji: "🦁", color: "from-violet-200 to-violet-100" },
  { letter: "M", word: "Monkey", emoji: "🐒", color: "from-purple-200 to-purple-100" },
  { letter: "N", word: "Nest", emoji: "🪹", color: "from-fuchsia-200 to-fuchsia-100" },
  { letter: "O", word: "Owl", emoji: "🦉", color: "from-pink-200 to-pink-100" },
  { letter: "P", word: "Penguin", emoji: "🐧", color: "from-rose-200 to-rose-100" },
  { letter: "Q", word: "Queen", emoji: "👑", color: "from-amber-200 to-amber-100" },
  { letter: "R", word: "Rainbow", emoji: "🌈", color: "from-orange-200 to-orange-100" },
  { letter: "S", word: "Sun", emoji: "☀️", color: "from-yellow-200 to-yellow-100" },
  { letter: "T", word: "Tiger", emoji: "🐯", color: "from-lime-200 to-lime-100" },
  { letter: "U", word: "Umbrella", emoji: "☂️", color: "from-emerald-200 to-emerald-100" },
  { letter: "V", word: "Violin", emoji: "🎻", color: "from-teal-200 to-teal-100" },
  { letter: "W", word: "Whale", emoji: "🐳", color: "from-cyan-200 to-cyan-100" },
  { letter: "X", word: "Xylophone", emoji: "🎹", color: "from-sky-200 to-sky-100" },
  { letter: "Y", word: "Yo-yo", emoji: "🪀", color: "from-blue-200 to-blue-100" },
  ...
  sections: [
    {
      ...
      visual: { type: "kg-banner", icon: "🎉", label: "Let's learn the ABC!", color: "from-fuchsia-200 to-pink-100", blocks: ["A", "B", "C"] },
      sentences: [
        "Hello little stars!",
    ...
    ...sections,
    {
      id: "outro",
      heading: "Well done!",
      visual: { type: "kg-banner", icon: "🌟", label: "You learned A to Z!", color: "from-amber-200 to-yellow-100", blocks: ["X", "Y", "Z"] },
      sentences: [
        "Wow, you did it!",
