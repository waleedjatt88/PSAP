...
export default function Accomplishments() {
  return (
    <div className="space-y-6">
      <div className="bg-[#0c0a21]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-5 shadow-2xl flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-white font-display">Accomplishments</h1>
          <p className="text-gray-400 text-sm">Earn badges as you complete lessons, quizzes, and streaks.</p>
        </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {badges.map((b) => (
          <div
            key={b.name}
            className={`rounded-2xl shadow-2xl p-5 text-center bg-[#0c0a21]/60 backdrop-blur-xl border ${
              b.unlocked ? "border-amber-500/20" : "border-white/10 opacity-50"
            }`}
          >
