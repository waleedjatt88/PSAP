...
export function buildSystemPrompt(context = {}) {
  ...
  if (lessonContent) {
    return [
      ...
      "",
      "IN_SCOPE=TRUE examples (teaching activities about LESSON_CONTENT):",
      ...
      `  - "Create a quiz with 10 MCQs and an answer key" → generate 10 multiple-choice questions covering the lesson, include the answer key`,
      `  - "Quiz me on this" → ask 3-5 short questions one at a time about the lesson`,
      ...
      "- For quizzes/exercises: number them clearly (1, 2, 3...), give 4 options labelled A/B/C/D for MCQs, and put the answer key at the end with brief explanations if marks are requested.",
      "- For 'quiz me' (interactive): ask ONE question at a time and wait for the student's answer.",
